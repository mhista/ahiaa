  ...
  List<BeamPage> buildPages(BuildContext context, BeamState state) {
    ...
    switch (location) {
      case RouteNames.home:
        return [BeamPage(title: 'Home', child: NavigationMenu())];
      case RouteNames.discover:
        return [BeamPage(title: 'Discover', child: DiscoverScreen())];
      case RouteNames.sell:
        return [BeamPage(title: 'Sell', child: UploadProductScreen())];
      case RouteNames.support:
        return [BeamPage(title: 'Support', child: SupportScreen())];
      case RouteNames.personalization:
        return [BeamPage(title: 'Personalization', child: ProfileScreen())];
      default:
        return [BeamPage(title: 'Home', child: NavigationMenu())];
    }
  }
